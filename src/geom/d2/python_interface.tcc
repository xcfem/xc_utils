...
class_<Circle2d, bases<Superficie2d> >("Circle2d")
  ...
  .def("getDiametro",&Circle2d::Diametro, "Return the object diameter.")
  .def("getPerimetro",&Circle2d::Perimetro, "Return the object perimeter.")
...
class_<Polygon3d, bases<D2to3d> >("Polygon3d")
  ...
  .def("getPerimetro",&Polygon3d::Perimetro, "Return the object perimeter.")
  ;
