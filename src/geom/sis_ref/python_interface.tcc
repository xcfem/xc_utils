...
class_<ref_SisCooRect1d2d, bases<ProtoGeom>, boost::noncopyable >("ref_CooSysRect1d2d", no_init)
  ...
  .def("getAxisVDir",&ref_SisCooRect1d2d::getAxisVDir)
  .def("getPosGlobal",&ref_SisCooRect1d2d::GetPosGlobal)
.def("getCooGlobales",&ref_SisCooRect1d2d::GetCooGlobales,"Return global coordinates of the argument.")
  .def("getPosLocal",&ref_SisCooRect1d2d::GetPosLocal)
  .def("getCooLocales",&ref_SisCooRect1d2d::GetCooLocales,"Return local coordinates of the argument.")
...
class_<Ref1d2d , bases<ref_SisCooRect1d2d> >("Ref1d2d")
  ...
  .def(init<const Pos2d &,const SisCooRect1d2d &>())
...
class_<ref_SisCooRect1d3d, bases<ProtoGeom>, boost::noncopyable >("ref_CooSysRect1d3d", no_init)
  ...
  .def("getAxisVDir",&ref_SisCooRect1d3d::getAxisVDir)
  .def("getPosGlobal",&ref_SisCooRect1d3d::GetPosGlobal)
  .def("getCooGlobales",&ref_SisCooRect1d3d::GetCooGlobales,"Return global coordinates of the argument.")
  .def("getPosLocal",&ref_SisCooRect1d3d::GetPosLocal)
.def("getCooLocales",&ref_SisCooRect1d3d::GetCooLocales, "Return local coordinates of the argument.")
...
class_<Ref1d3d , bases<ref_SisCooRect1d3d> >("Ref1d3d")
  ...
  .def(init<const Pos3d &,const SisCooRect1d3d &>())
...
class_<ref_SisCooRect2d2d, bases<ProtoGeom>, boost::noncopyable >("ref_CooSysRect2d2d", no_init)
  ...
  .def("getAxisVDir",&ref_SisCooRect2d2d::getAxisVDir)
  .def("getPosGlobal",&ref_SisCooRect2d2d::GetPosGlobal)
  .def("getCooGlobales",&ref_SisCooRect2d2d::GetCooGlobales,"Return global coordinates of the argument.")
  .def("getPosLocal",&ref_SisCooRect2d2d::GetPosLocal)
  .def("getCooLocales",&ref_SisCooRect2d2d::GetCooLocales, "Return local coordinates of the argument.")
...
class_<Ref2d2d , bases<ref_SisCooRect2d2d> >("Ref2d2d")
  .def(init<const Pos2d &>())
  .def(init<const Pos2d &,const SisCooRect2d2d &>())
  .def(init<const Pos2d &,const Vector2d &>())
  .def(init<const Pos2d &,const Dir2d &>())
  .def(init<const Pos2d &,const Pos2d &>())
...
class_<ref_SisCooRect2d3d, bases<ProtoGeom>, boost::noncopyable >("ref_CooSysRect2d3d", no_init)
  ...
  .def("getAxisVDir",&ref_SisCooRect2d3d::getAxisVDir)
  .def("getPosGlobal",&ref_SisCooRect2d3d::GetPosGlobal)
  .def("getCooGlobales",&ref_SisCooRect2d3d::GetCooGlobales,"Return global coordinates of the argument.")
  .def("getPosLocal",&ref_SisCooRect2d3d::GetPosLocal)
  .def("getCooLocales",&ref_SisCooRect2d3d::GetCooLocales, "Return local coordinates of the argument.")
...
class_<Ref2d3d , bases<ref_SisCooRect2d3d> >("Ref2d3d")
  .def(init<const Pos3d &>())
  .def(init<const Pos3d &,const SisCooRect2d3d &>())
...
class_<ref_SisCooRect3d3d, bases<ProtoGeom>, boost::noncopyable >("ref_CooSysRect3d3d", no_init)
  ...
  .def("getAxisVDir",&ref_SisCooRect3d3d::getAxisVDir)
  .def("getPosGlobal",&ref_SisCooRect3d3d::GetPosGlobal)
  .def("getCooGlobales",&ref_SisCooRect3d3d::GetCooGlobales,"Return global coordinates of the argument.")
  .def("getPosLocal",&ref_SisCooRect3d3d::GetPosLocal)
  .def("getCooLocales",&ref_SisCooRect3d3d::GetCooLocales, "Return local coordinates of the argument.")
...
class_<Ref3d3d , bases<ref_SisCooRect3d3d> >("Ref3d3d")
  .def(init<const Pos3d &>())
  .def(init<const Pos3d &,const SisCooRect3d3d &>())
  .def(init<const Pos3d &,const Pos3d &>())
  .def(init<const Pos3d &,const Pos3d &,const Pos3d &>())
  .def(init<const Pos3d &,const Vector3d &,const Vector3d &>())
