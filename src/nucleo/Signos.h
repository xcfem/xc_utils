...
class Token
  {
  public:
    enum TipoToken {DIGIT, LETRA, IDENT, IDENT_WITH_MEMBER, INT_LIT, DBL_LIT, EXPR_LIT, STR_LIT, ERROR, POINT, COMA, SPACE, COMILLA, COMILLAS, FIN, PARENT_DCHO, PARENT_IZDO,CORCHETE_DCHO, CORCHETE_IZDO, VECTOR, OP_PREFIJO, OP_NEG, OP_SUMA, OP_RESTA, OP_MULT, OP_DIV, OP_POW, OP_MENOR, OP_MAYOR, OP_IGUAL, OP_MENORIGUAL, OP_MAYORIGUAL, OP_DISTINTO, OP_STO, OP_AND, OP_OR, OP_NOT, BASERCL, OP_RCL, OP_AT};
