...
\coefs_psi
  {
    \defCoefs["iapf_permanent"]{\psi_0{1} \psi_1{1} \psi_2{1}}
    \defCoefs["iapf_snow"]{\psi_0{0.6} \psi_1{0.2} \psi_2{0.0}}
    \defCoefs["iapf_wind"]{\psi_0{0.6} \psi_1{0.5} \psi_2{0.0}}
    \defCoefs["iapf_thermal"]{\psi_0{0.6} \psi_1{0.5} \psi_2{0.0}}
