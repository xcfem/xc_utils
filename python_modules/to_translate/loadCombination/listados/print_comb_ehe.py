    ...
    \comb_elu_persistentes
      {
        ...
        arch_salida_ltx.open("./ejemplos/salida/comb_ehe_elu_pt.tex","w")
    ...
    \comb_elu_accidentales
      {
        ...
        arch_salida_ltx.open("./ejemplos/salida/comb_ehe_elu_acc.tex","w")
        execfile("print_combinaciones.acc")
        arch_salida_ltx.close()
      }
    \comb_elu_sismicas
      {
        ...
        arch_salida_ltx.open("./ejemplos/salida/comb_ehe_elu_sism.tex","w")
        execfile("print_combinaciones.acc")
        arch_salida_ltx.close()
      }
    \comb_els_poco_frecuentes
      {
        ...
        arch_salida_ltx.open("./ejemplos/salida/comb_ehe_els_pf.tex","w")
        execfile("print_combinaciones.acc")
        arch_salida_ltx.close()
      }
    \comb_els_frecuentes
      {
        ...
        arch_salida_ltx.open("./ejemplos/salida/comb_ehe_els_f.tex","w")
        execfile("print_combinaciones.acc")
        arch_salida_ltx.close()
      }
    \comb_els_cuasi_permanentes
      {
        ...
        arch_salida_ltx.open("./ejemplos/salida/comb_ehe_els_cp.tex","w")
        execfile("print_combinaciones.acc")
        arch_salida_ltx.close()
      }
  }
