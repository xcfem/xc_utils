...
partial_safety_factors["permanentes_nc_EHE_ctr_normal"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(1,1.5,1,1),loadCombinations.SLSPartialSafetyFactors(1,1))
#Coeficientes de ponderación para acciones variables, control de ejecución normal.
partial_safety_factors["variables_EHE_ctr_normal"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0,1.5,0,1),loadCombinations.SLSPartialSafetyFactors(0,1))
#Coeficientes de ponderación para acciones sísmicas, control de ejecución normal.
partial_safety_factors["sismicas_EHE_ctr_normal"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0,1,1,1),loadCombinations.SLSPartialSafetyFactors(0,0))
#Coeficientes de ponderación para acciones accidentales, control de ejecución normal.
partial_safety_factors["accidentales_EHE_ctr_normal"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0,0,1,1),loadCombinations.SLSPartialSafetyFactors(0,0))
#Coeficientes de ponderación para acciones permanentes, control de ejecución intenso.
partial_safety_factors["permanentes_EHE_ctr_intenso"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(1,1.35,1,1),loadCombinations.SLSPartialSafetyFactors(1,1))

#Coeficientes de ponderación para acciones permanentes de valor no constante, control de ejecución intenso.
partial_safety_factors["permanentes_nc_EHE_ctr_intenso"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(1,1.5,1,1),loadCombinations.SLSPartialSafetyFactors(1,1))
#Coeficientes de ponderación para acciones variables, control de ejecución intenso.
partial_safety_factors["variables_EHE_ctr_intenso"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0,1.5,0,1),loadCombinations.SLSPartialSafetyFactors(0,1))
#Coeficientes de ponderación para acciones sísmicas, control de ejecución intenso.
partial_safety_factors["sismicas_EHE_ctr_intenso"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0,1,1,1),loadCombinations.SLSPartialSafetyFactors(0,0))
#Coeficientes de ponderación para acciones accidentales, control de ejecución intenso.
partial_safety_factors["accidentales_EHE_ctr_intenso"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0,0,1,1),loadCombinations.SLSPartialSafetyFactors(0,0))

combination_factors_EHE= factors.getCombinationFactors()
...
partial_safety_factors["permanentes_EHE_ctr_normal"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(1,1.35,1,1),loadCombinations.SLSPartialSafetyFactors(1,1))
...
actionsAndFactors.permanentActions['default'].partial_safety_factors= partial_safety_factors["permanentes_EHE_ctr_intenso"]
actionsAndFactors.variableActions['default'].partial_safety_factors= partial_safety_factors["variables_EHE_ctr_intenso"]
actionsAndFactors.accidentalActions.partial_safety_factors= partial_safety_factors["accidentales_EHE_ctr_intenso"]
