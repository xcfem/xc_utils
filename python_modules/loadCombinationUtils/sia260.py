...
#Poussée des terres.
partial_safety_factors["terres"]= loadCombinations.PartialSafetyFactors(loadCombinations.ULSPartialSafetyFactors(0.7,1.35,1,1),loadCombinations.SLSPartialSafetyFactors(1,1))
